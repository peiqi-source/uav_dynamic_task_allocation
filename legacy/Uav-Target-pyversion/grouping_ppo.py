...
import torch
import gym
from target_grouping_functions import group_targets_dis
from target_grouping_functions import group_targets_guide_1
from target_grouping_functions import group_targets_guidedouble
...
obs = env.reset()[0]
for _ in range(100):
    action, _states = obs.predict(obs)
